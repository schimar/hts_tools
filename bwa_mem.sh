...
for i in ~/Desktop/boechera/lasio/vsearch/run/*.fastq; do
	...
	~/bwa/bwa mem -t 10 -w 50 -k 20 -a -C -R "@RG\tID:$id\tLB:$id\tSM:$id\tPL:ILLUMINA" l105_88strictaMEM2Cons76_5hdr_clnd.fasta $i > out/AllRds/${id}.sam
