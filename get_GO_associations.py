...
with open(sys.argv[1], 'rb') as file:
    for line in file:
        ...
        if len(go_terms) == 0:
            ...
            if len(go_split) == 1:
                newfile.write(str(gene + '\t' +  go_split[0] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
            elif len(go_split) == 2:
                newfile.write(str(gene + '\t' +  go_split[0] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
                newfile.write(str(gene + '\t' +  go_split[1] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
            elif len(go_split) == 3:
                newfile.write(str(gene + '\t' +  go_split[0] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
                newfile.write(str(gene + '\t' +  go_split[1] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
                newfile.write(str(gene + '\t' +  go_split[2] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
            elif len(go_split) == 4:
                newfile.write(str(gene + '\t' +  go_split[0] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
                newfile.write(str(gene + '\t' +  go_split[1] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
                newfile.write(str(gene + '\t' +  go_split[2] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
                newfile.write(str(gene + '\t' +  go_split[3] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
            elif len(go_split) == 5:
                newfile.write(str(gene + '\t' +  go_split[0] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
                newfile.write(str(gene + '\t' +  go_split[1] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
                newfile.write(str(gene + '\t' +  go_split[2] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
                newfile.write(str(gene + '\t' +  go_split[3] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
                newfile.write(str(gene + '\t' +  go_split[4] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
            elif len(go_split) == 6:
                newfile.write(str(gene + '\t' +  go_split[0] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
                newfile.write(str(gene + '\t' +  go_split[1] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
                newfile.write(str(gene + '\t' +  go_split[2] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
                newfile.write(str(gene + '\t' +  go_split[3] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
                newfile.write(str(gene + '\t' +  go_split[4] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
                newfile.write(str(gene + '\t' +  go_split[5] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
            elif len(go_split) == 7:
                newfile.write(str(gene + '\t' +  go_split[0] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
                newfile.write(str(gene + '\t' +  go_split[1] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
                newfile.write(str(gene + '\t' +  go_split[2] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
                ...
                newfile.write(str(gene + '\t' +  go_split[4] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
                newfile.write(str(gene + '\t' +  go_split[5] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
                newfile.write(str(gene + '\t' +  go_split[6] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
            elif len(go_split) == 8:
                newfile.write(str(gene + '\t' +  go_split[0] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
                newfile.write(str(gene + '\t' +  go_split[1] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
                newfile.write(str(gene + '\t' +  go_split[2] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
                ...
                newfile.write(str(gene + '\t' +  go_split[5] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
                newfile.write(str(gene + '\t' +  go_split[6] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
                newfile.write(str(gene + '\t' +  go_split[7] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
            elif len(go_split) == 9:
                newfile.write(str(gene + '\t' +  go_split[0] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
                newfile.write(str(gene + '\t' +  go_split[1] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
                newfile.write(str(gene + '\t' +  go_split[2] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
                ...
                newfile.write(str(gene + '\t' +  go_split[6] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
                newfile.write(str(gene + '\t' +  go_split[7] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
                newfile.write(str(gene + '\t' +  go_split[8] + '\t' + tair10_symbol + '\t' + tair10_defline + '\n'))
            else: 
                continue
